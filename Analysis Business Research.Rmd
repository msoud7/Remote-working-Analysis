...
WLB_density <- ggplot(data, aes(x = WLB_score)) +
  ...
  labs(title = "Density plot of Work-Life Balance", x = "WLB Score") +
  theme_minimal() +
...
WFC_density <- ggplot(data, aes(x = WFC_score)) +
  ...
  labs(title = "Density plot of Work-Family Conflict", x = "WFC Score") +
  theme_minimal() +
...
FWC_density <- ggplot(data, aes(x = FWC_score)) +
  ...
  labs(title = "Density plot of Family-Work Conflict", x = "FWC Score") +
  theme_minimal() +
  theme(axis.title.y = element_blank(),         
        axis.text.y = element_blank(),          
        axis.ticks.y = element_blank())      
...
grid.arrange(WLB_density, WFC_density, FWC_density, ncol = 3, 
             top = textGrob("Frequency", gp = gpar(fontsize = 14)), 
            )
```
